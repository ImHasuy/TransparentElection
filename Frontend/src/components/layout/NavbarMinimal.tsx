import {Button, Image, rem, useMantineTheme} from "@mantine/core";
import {useContext, useEffect, useState} from "react";
import { useNavigate } from "react-router-dom";
import useAuth from "../../hooks/useAuth";
import {AuthContext} from "../../context/AuthContext.tsx";
import classes from "./NavbarMinimalColored.module.css";
import {IconAlarm, IconGitPullRequest, IconHome, IconLogout} from "@tabler/icons-react";
...
export function NavbarMinimal({ toggle = () => {} }: NavbarMinimalProps) {
    ...
    return (
        <nav className={classes.navbar}>
            <Image  src="" alt="logo" w={150} px={5} mb={20} m="auto" />
